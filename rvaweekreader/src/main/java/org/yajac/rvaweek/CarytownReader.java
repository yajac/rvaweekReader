...
public class CarytownReader extends FacebookAPIReaderv2 implements RequestHandler<ScheduledEvent, Integer> {

    private static final String SOURCE_URL = "http://carytownrva.org/play.html";
    private static final String LOCATION_NAME = "Carytown";
    private static final String CATEGORY = "Neighborhood";

    private static final String FACEBOOK_ID = "22033716150";
