...
public class VeilReader extends FacebookAPIReader implements RequestHandler<ScheduledEvent, Integer> {

    private static String SOURCE_URL = "http://www.theveilbrewing.com/events-list/";
    private static String LOCATION_NAME = "The Veil Brewing Co.";
    private static String CATEGORY = "Beer";

    public static String FACEBOOK_ID = "829480530469463";
